<template>
  <section class="panel-page-sec uncoming" >

    <div class="container">


        <component__event_claster 
        :categorySliderView="true"
        :clasterTitle="'Предстоящие'"
        :clasterTitleIcon="liveIcon"
        />
 ...
 import component__event_claster from '@/components/box/event-claster.vue'
